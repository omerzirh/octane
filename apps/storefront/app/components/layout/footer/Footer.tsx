        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-6 w-full flex-col items-center gap-8 sm:flex-row sm:items-start sm:gap-16">
          <div className="flex w-full flex-col items-center gap-8 sm:w-auto sm:items-start sm:gap-9 sm:col-span-2 lg:col-span-3">
            <div className="flex flex-col gap-5">
              <h4 className="font-bold">Original & Human-Made</h4>
              <p className="text-sm">
                Octane Store curates and creates original, authentic designs crafted by real people. Every product is made with artistry and passion—no mass production, just genuine human creativity.
              </p>
            </div>
            <LogoStoreName />
          </div>
          ...
          <div className="flex flex-col gap-5 lg:col-span-2">
            ...
            <div className="flex flex-col gap-4 mt-4">
              <h5>Worldwide</h5>
              <p className="text-sm">
                Octane Store is online and open 24/7. Join our community of creators from anywhere in the world!
              </p>
            </div>
          </div>
        </div>
